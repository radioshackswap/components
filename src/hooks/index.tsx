...
import { CHAINS, ChainId } from '@radioshackswap/sdk2';
...
export const useRadioShackWeb3 = () => {
  const context = useContext(Web3Context);
  if (context === undefined) {
    throw new Error('useRadioShackWeb3 must be used within a component wrapped with RadioShackWeb3Provider');
  }
  return context;
};

export const RadioShackWeb3Provider: FC<Web3ProviderProps> = ({
  children,
  library,
  chainId,
  account,
...
export function useLibrary(): { library: any; provider: any } {
  ...
  const { library: userProvidedLibrary } = useRadioShackWeb3();
