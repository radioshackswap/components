...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from '@radioshackswap/sdk2';
import { useMemo } from 'react';
import { BIPS_BASE, INITIAL_ALLOWED_SLIPPAGE, ZERO_ADDRESS } from 'src/constants';
...
import { useChainId, useLibrary, useRadioShackWeb3 } from './index';
...
function useSwapCallArguments(
  ...
  const { account, chainId } = useRadioShackWeb3();
                ...
                return contract.callStatic[methodName](...args, options)
                  ...
                  .catch((callError) => {
                    ...
                    switch (callError.reason) {
                      case 'RadioShackRouter: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'RadioShackRouter: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =
