// the RadioShack Default token list lives here
export const RADIOSHACK_LIST = 'https://static.radioshack.org/tokenlist/radioshack.tokenlist.json';

export const DEFAULT_TOKEN_LISTS_SELECTED: string[] = [RADIOSHACK_LIST];

export const DEFAULT_TOKEN_LISTS: string[] = [RADIOSHACK_LIST];

// Token addresses (excluding RADIO and WETH) ported from:
// https://raw.githubusercontent.com/radioshackswap/tokenlists/main/aeb.tokenlist.json
