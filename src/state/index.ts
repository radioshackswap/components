...
export const RADIOSHACK_PERSISTED_KEYS: string[] = [
  'puser',
  'plists',
  'ptransactions',
  'pwatchlists',
...
export const radioshackReducers = {
  papplication,
  ptransactions,
  pswap,
  plists,
...
const store = configureStore({
  reducer: radioshackReducers,
  middleware: [...getDefaultMiddleware({ thunk: false }), save({ states: RADIOSHACK_PERSISTED_KEYS })],
  preloadedState: load({ states: RADIOSHACK_PERSISTED_KEYS }),
});
